...
* **RAW:**
  * Работает на прямую, усредненный вариант получения бита в реальном времени.
* **OSU**
  * Попытка повторить стиль пульсаций из OSU.
 
Попробуйте оба и посмотрите какой будет лучше для вас! ❤
...
* К комментариям привязывается ваш никнейм из Telegram, в окне показывается обложка, название и исполнители

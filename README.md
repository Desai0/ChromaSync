# ☁️ Подключитесь к инфраструктуре ChromaSync Cloud и получите свой Personal API Token: [@ChromaSyncBOT](https://t.me/ChromaSyncBOT)
...
## ☁️ ChromaSync Cloud (Серверные функции)

Для работы сложных функций, требующих баз данных и вычислительных мощностей, мы запустили собственную серверную инфраструктуру — **ChromaSync Cloud**. Вы можете поддержать проект и получить личный `API-Token` у нашего [Telegram-бота](https://t.me/ChromaSyncBOT). 
...
**ChromaSync Cloud (Токены)**: https://t.me/ChromaSyncBOT <br>
